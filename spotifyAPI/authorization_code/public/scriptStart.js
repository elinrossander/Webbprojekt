...
pictures.classList.add('spinn');
pictures.addEventListener("webkitAnimationEnd", switchPictures(i))

//}
function switchPictures(i){
    var elem = document.getElementById(i);
    console.log(elem);
    elem.remove();//varför tar du bort allt....
    var i = ((i + 1) % 3);
    pictures.innerHTML = "<img src=\"1.jpg\" id=\""+ i +"\" style=\"width:100px;height:100px;\">"  
}
        
//function initzWheel(param0, param1, param2, param3){
//    var pictures =document.getElementById('pictures');
//    pictures.innerHTML = "<img src=\"" + param0 + "\" id=\"0\" style=\"width:100px;height:100px;\">"
//    pictures.innerHTML = "<img src=\"" + param1 + "\" id=\"1\" style=\"width:100px;height:100px;\">"
//    pictures.innerHTML = "<img src=\"" + param2 + "\" id=\"2\" style=\"width:100px;height:100px;\">"
//    pictures.innerHTML = "<img src=\"" + param3 + "\" id=\"3\" style=\"width:100px;height:100px;\">"
//}
     /**
